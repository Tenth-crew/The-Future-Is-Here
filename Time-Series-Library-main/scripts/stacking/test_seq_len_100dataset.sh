...
for seq_len in $seq_lens; do
    echo "Running experiment with seq_len=$seq_len"
    ...
    for repo in "${repoName[@]}"; do
        ...
        --result_path workresult/stacking/Parameter_Sensitivity_Analysis/seq_len/exp_"$meta_model"_2model_PatchTST_DLinear_seqlen"$seq_len"_100dataset \
        --use_context_aware \
        ...
        --des 'Exp' \
        --inverse \
        --itr 1 | tee -a logs/stacking/stacking_test_100_seqlen"$seq_len".log
    done
done